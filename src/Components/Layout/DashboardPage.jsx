...
function StatCard({ title, value, accent = "#36b446" }) {
  return (
    <Card
      style={{
        borderRadius: 14,
...
function ProgressRow({ label, value, color }) {
  const percent = 100; // decorative line; replace with real % if available
  return (
    <div style={{ width: "100%" }}>
      <div
        style={{
...
export default function DashboardPage() {
  // Replace with API data later (use Axios in a future step)
  const stats = [
    { title: "Total FUM", value: "$106M", accent: "#36b446" },
    ...
    { title: "Total Income", value: "$762K", accent: "#36b446" },
  ];

  const genders = [
    { label: "Female", value: 230, icon: "👩", color: "#FF6B6B" },
    { label: "Male", value: 189, icon: "👨", color: "#36b446" },
  ];
  ...
  const riskProfiles = [
    ...
    { label: "Conservative", value: 62, color: "#52c41a" },
  ...
  return (
    <div style={{ padding: 12 }}>
      ...
      <YesNoSwitch name="riskAccepted" value={true} onChange={() => {}} />

      {/* 

      We Need this but for now i have commented it
