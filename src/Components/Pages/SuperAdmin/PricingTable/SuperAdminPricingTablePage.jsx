  ...
  return (
    ...
    >
      <button
        ...
        style={{
          border: "none",
          background: !isYearly ? "#f0fdf4" : "transparent",
          color: !isYearly ? PRIMARY_GREEN : "#6b7280",
          borderRadius: 999,
          padding: "6px 16px",
          fontSize: 13,
          fontWeight: 600,
  ...
  return (
    <Card
      style={{
        ...
        height: "100%",
        borderRadius: 14,
        border: isPopular ? `2px solid ${PRIMARY_GREEN}` : "1px solid #e5e7eb",
        boxShadow: isPopular
    ...
    >
      ...
      <Button
        ...
        onClick={() =>
          activePrice?.price_id && onSubscribe(activePrice.price_id)
        }
        style={{
          borderRadius: 8,
          fontWeight: 700,
    ...
    >
      ...
      >
        <div style={{ maxWidth: 640 }}>
          ...
          >
            Manage the plans advisers can subscribe to. Edit pricing or
            features, view who&apos;s subscribed to each tier, and add new plans
