...
const MIDDLEWARE_CONFIG = {
  bankAccountFinance: {
    addEndpoint: "/bankAccountFinance/Add",
    updateEndpoint: "/bankAccountFinance/Update",
    countLabel: "Number of Bank Accounts",
    width: 680,
  },
  termDepositsFinance: {
    addEndpoint: "/termDepositsFinance/Add",
    updateEndpoint: "/termDepositsFinance/Update",
    countLabel: "Number of Term Deposits",
    width: 680,
  },
  australianShareMarket: {
    addEndpoint: "/australianShareMarket/Add",
    updateEndpoint: "/australianShareMarket/Update",
    countLabel: "Number of Australian Shares/ETFs",
    width: 800,
  },
  managedFund: {
    addEndpoint: "/managedFund/Add",
    updateEndpoint: "/managedFund/Update",
    countLabel: "Number of Platform",
    width: 900,
  },
  investmentBondFinance: {
    addEndpoint: "/investmentBondFinance/Add",
    updateEndpoint: "/investmentBondFinance/Update",
    countLabel: "Number of Investment Bonds",
    width: 800,
  },
  superAnnuationIssues: {
    addEndpoint: "/superAnnuationIssues/Add",
    updateEndpoint: "/superAnnuationIssues/Update",
    countLabel: "Number of Super Funds",
    width: 1000,
    noJoint: true,
  },
  accountBasedPensionIssues: {
    addEndpoint: "/accountBasedPensionIssues/Add",
    updateEndpoint: "/accountBasedPensionIssues/Update",
    countLabel: "Number of Account Based Pensions",
    width: 1000,
    noJoint: true,
  },
  annuitiesIssues: {
    addEndpoint: "/annuitiesIssues/Add",
    updateEndpoint: "/annuitiesIssues/Update",
    countLabel: "Number of Annuities",
    width: 1500,
    noJoint: true,
  },
  BusinessAsCompanyStructure: {
    addEndpoint: "/BusinessAsCompanyStructure/Add",
    updateEndpoint: "/BusinessAsCompanyStructure/Update",
    countLabel: "Number of Companies",
    width: 1400,
    noJoint: true,
  },
  BusinessAsTrusts: {
    addEndpoint: "/BusinessAsTrusts/Add",
    updateEndpoint: "/BusinessAsTrusts/Update",
    countLabel: "Number of Trusts",
    width: 1400,
    noJoint: true,
  },
  SMSFBank: {
    addEndpoint: "/SMSFBank/Add",
    updateEndpoint: "/SMSFBank/Update",
    countLabel: "Number of Bank Accounts",
    width: 680,
    ...customConfig.SMSF,
  },
  SMSFTermDeposits: {
    addEndpoint: "/SMSFTermDeposits/Add",
    updateEndpoint: "/SMSFTermDeposits/Update",
    countLabel: "Number of Term Deposits",
    width: 680,
    ...customConfig.SMSF,
  },
  SMSFAustralianShares: {
    addEndpoint: "/SMSFAustralianShares/Add",
    updateEndpoint: "/SMSFAustralianShares/Update",
    countLabel: "Number of Australian Shares/ETFs",
    width: 800,
    ...customConfig.SMSF,
  },
  SMSFManagedFunds: {
    addEndpoint: "/SMSFManagedFunds/Add",
    updateEndpoint: "/SMSFManagedFunds/Update",
  ...
  familyBank: {
    addEndpoint: "/familyBank/Add",
    updateEndpoint: "/familyBank/Update",
    countLabel: "Number of Bank Accounts",
    width: 680,
    ...customConfig.Trust,
  },
  familyTermDeposit: {
    addEndpoint: "/familyTermDeposit/Add",
    updateEndpoint: "/familyTermDeposit/Update",
    countLabel: "Number of Term Deposits",
    width: 680,
    ...customConfig.Trust,
  },
  familyAustralianShare: {
    addEndpoint: "/familyAustralianShare/Add",
    updateEndpoint: "/familyAustralianShare/Update",
    countLabel: "Number of Australian Shares/ETFs",
    width: 800,
    ...customConfig.Trust,
  },
  familyMangedFunds: {
    addEndpoint: "/familyMangedFunds/Add",
    updateEndpoint: "/familyMangedFunds/Update",
    countLabel: "Number of Platform Investments",
    width: 1000,
    ...customConfig.Trust,
  },
...
const MiddleWare = ({ modalData }) => {
  ...
  const handleFinish = async (values) => {
    ...
    try {
      ...
      message.success(
        `${modalData?.title || "Financial section"} ${sectionData?._id ? "updated" : "saved"} successfully`,
      );
