// Shared Goals & Objectives catalog (icons/titles/descriptions).
// This is used by both the Goals UI and the Client Summary so icons stay consistent.

export const GOALS_OBJECTIVES_CARDS = [
  {
    title: "Age Care",
    key: "AgeCare",
    sections: [
